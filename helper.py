...
def read_csv():
	...
	return:
		a matrix data representing all the row vectors in the csv data
	"""
...
def get_composition(compound,data):
	...
	return:
		a list of all the corresponding row vectors which has non zero entry of the given compound
	"""
	result = []
